...
public class PDFExporter {
    ...
    private void writeTableSign(PdfPTable table) throws BadPdfFormatException, BadElementException, IOException {
        ...
        Image image = Image.getInstance("https://help.pacisoft.com/wp-content/uploads/2021/10/mau_chu_ky-e1634486941944.jpg"); // Replace with the actual path to your image file
...
//    }
    ...
    public static byte[] generatePDFData() throws DocumentException {
        ...
        try {
            PdfWriter.getInstance(document, outputStream);
            document.open();
            document.add(new Paragraph("Testing, this is a sample PDF!"));
            document.close();
        } catch (DocumentException e) {
            e.printStackTrace();
        }
