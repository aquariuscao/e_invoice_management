...
public interface InvoiceService {
	...
	void sendMailToCustomer(HttpServletResponse response, InvoiceEntity invoiceEntity, int id) throws MessagingException, DocumentException, IOException, TransformerException;
